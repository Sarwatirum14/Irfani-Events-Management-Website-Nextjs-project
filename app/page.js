  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="IRFANI Events Management - Turning your dreams into reality." />
      </Head>
      ...
      <div className="font-sans">
        ...
        <section className="flex flex-col md:flex-row justify-between p-10 bg-black text-white">
          <div className="md:w-1/2 p-5 justify-center mt-20">
            ...
            <p className="text-justify">
              We turn your dreams into reality with expert planning and flawless execution.
              Every event we manage is a perfect blend of creativity, professionalism, and passion.
        ...
        {/* About Section */}
        <section id="about" className="flex flex-col md:flex-row-reverse justify-between p-10 bg-black text-white">
          <div className="md:w-1/2 flex justify-center items-center">
            <Image
              src="/about.jpg"
              alt="About IRFANI"
        ...
        {/* Events Section */}
        <section id="events" className="p-10 bg-black text-white">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={event} className="bg-pink-200 text-center p-4 rounded shadow text-black">
